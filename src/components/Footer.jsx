...
function Footer() {
  return (
    <div className='max-w-7xl mx-auto flex flex-col items-center border-t-2 border-gray-400 mt-10 py-10'>
      <div className='flex w-full'>
        <p className='flex items-center w-full gap-2 text-2xl font-bold'> <GiFireBowl size={30}/> Cravingo</p>
        ...
        <ul className='flex w-full items-center justify-end gap-6 sm:gap-8 my-2 cursor-pointer'>
      ...
      <div className='my-4 w-full items-center justify-center flex'>
         <p>
